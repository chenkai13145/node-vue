...
<script>
import {getTranInfoCarsee} from '../../../api/monitor/warehouse'
import echarts from 'echarts'
export default {
  data () {
    return {
    // 城市
    cityData :['广汽本田', '广汽丰田', '广汽传祺', '广汽三菱', '广汽菲克', '其他客户'],
    // 数值
  ...
  methods: {
    ...
    requestList(){
      this.loading()
          ...
          .catch(err=>{
            this.doughnut.hideLoading()
            this.$emit('showEmptyFn',{show:false,type:'CommodityCarBrand'})
          })
    }
  },
  created() {
