      ...
      <el-collapse-item>
          <template slot="title">
            <div @click="upDown1" class="upDown">
                <img v-show="!show1" src="../../../assets/monitoring/ic-selected.png" style="margin-right:10px">
                <img v-show="show1" src="../../../assets/monitoring/ic-select.png" style="margin-right:10px">
                <span>投资公司</span>
            </div>
          </template>
          <ul class="select-con">
      ...
      <el-collapse-item>
          <template slot="title">
            <div @click="upDown2" class="upDown">
                <img v-show="!show2" src="../../../assets/monitoring/ic-selected.png" style="margin-right:10px">
                <img v-show="show2" src="../../../assets/monitoring/ic-select.png" style="margin-right:10px">
                <span>客户</span>
            </div>
          </template>
          <ul class="select-con">
      ...
      <el-collapse-item>
          <template slot="title">
            <div @click="upDown3" class="upDown">
                <img v-show="!show3" src="../../../assets/monitoring/ic-selected.png" style="margin-right:10px">
                <img v-show="show3" src="../../../assets/monitoring/ic-select.png" style="margin-right:10px">
                <span>客户城市</span>
            </div>
          </template>
          <ul class="select-con">
      ...
      <el-collapse-item v-if="$route.path!='/monitoring-full-capacity'">
          <template slot="title">
            <div @click="upDown4" class="upDown">
                <img v-show="!show4" src="../../../assets/monitoring/ic-selected.png" style="margin-right:10px">
                <img v-show="show4" src="../../../assets/monitoring/ic-select.png" style="margin-right:10px">
                <span>商业车品牌</span>
            </div>
          </template>
          <ul class="select-con">
