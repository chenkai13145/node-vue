  ...
  <baidu-map class="bm-view" center="河北" @ready="handler" :scroll-wheel-zoom="true" >
    ...
    <bml-marker-clusterer :averageCenter="true" :styles= 'styles'>
       <bm-marker 
          ...
          :icon="{url: marker.event_type ? '/img/img_event_safe@2x.png' 
                       : marker.level==0 ? '/img/ic_location_lower.png' 
                       : marker.level==1 ? '/img/ic_location_mid.png' 
                       : '/img/ic_location_high.png', size: {width: 50, height: 58}}"
